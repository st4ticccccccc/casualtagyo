...
class GameInfo:
    def __init__(self):
        self.TitleId : str = "FB560"
        self.SecretKey : str = "4H3HC49PWM9AHI397C9IB6EOCR9N4RJFJPWXAAXPR178XQA7DW"
        self.ApiKey : str = "OC|25215508088089263|fd6f67a2d223ccac4106d3df23faf696"
